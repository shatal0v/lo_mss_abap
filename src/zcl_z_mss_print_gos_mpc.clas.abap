class ZCL_Z_MSS_PRINT_GOS_MPC definition
  public
...
public section.
  ...
  types:
TT_PRINT_GOS type standard table of TS_PRINT_GOS. .
  types:
  ...
  constants GC_PRINT_GOS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Print_Gos' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_PRINT_GOS_MPC=======CP' ##NO_TEXT.

  methods DEFINE_PRINT_GOS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_PRINT_GOS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_PRINT_GOS_SRV' ).

define_print_gos( ).
  endmethod.


  method DEFINE_PRINT_GOS.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Print_Gos' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_PRINT_GOS_MPC=>TS_PRINT_GOS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Print_Gos_Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200321155434'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Print_Gos'.                            "#EC NOTEXT
