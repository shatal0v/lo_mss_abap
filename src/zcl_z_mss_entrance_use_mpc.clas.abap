class ZCL_Z_MSS_ENTRANCE_USE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_ENTRANCE_USE_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_Z_MSS_ENTRANCE_USE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_ENTRANCE_USER_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_ENTRANCE_USE_MPC=>TS_ENTRANCE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ENTRANCE' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200321162443'.                  "#EC NOTEXT
