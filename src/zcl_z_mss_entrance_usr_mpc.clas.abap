class ZCL_Z_MSS_ENTRANCE_USR_MPC definition
  public
...
public section.
  ...
  types:
TT_ENTRANCE type standard table of TS_ENTRANCE. .
  types:
  ...
  constants GC_ENTRANCE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ENTRANCE' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_ENTRANCE_USR_MPC====CP' ##NO_TEXT.

  methods DEFINE_ENTRANCE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_ENTRANCE_USR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_ENTRANCE_USR_SRV' ).

define_entrance( ).
  endmethod.


  method DEFINE_ENTRANCE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ENTRANCE' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'ORGEH' iv_abap_fieldname = 'ORGEH' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_ENTRANCE_USR_MPC=>TS_ENTRANCE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ENTRANCE_SET' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20170830124003'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ENTRANCE'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ORGEH'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ENTRANCE'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
