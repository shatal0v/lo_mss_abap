*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_ENTR_USER
*   generation date: 17.03.2020 at 13:38:25
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_ENTR_USER      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_ENTR_USER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_ENTR_USER_EXTRACT
TOTAL = ZVHR_ENTR_USER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_ENTR_USER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_ENTR_USER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ENTR_USER_EXTRACT
TOTAL = ZVHR_ENTR_USER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_ENTR_USER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_ENTR_USER'
...
TOTAL = ZVHR_ENTR_USER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_ENTR_USER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_ENTR_USER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVHR_ENTR_USER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVHR_ENTR_USER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ENTR_USER_EXTRACT
TOTAL = ZVHR_ENTR_USER_TOTAL
