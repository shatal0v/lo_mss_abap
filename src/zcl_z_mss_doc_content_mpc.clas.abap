class ZCL_Z_MSS_DOC_CONTENT_MPC definition
  public
...
public section.
  ...
  begin of TS_SCHEDULE,
     ...
     MAIN_USER type C length 200,
     ENTRANCE_USER type C length 200,
     OBJID type string,
  end of TS_SCHEDULE. .
  types:
TT_SCHEDULE type standard table of TS_SCHEDULE. .
  types:
  ...
  types:
TT_ATTDOC type standard table of TS_ATTDOC. .

  constants GC_ATTDOC type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'attDoc' ##NO_TEXT.
  constants GC_SCHEDULE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'schedule' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_DOC_CONTENT_MPC=====CP' ##NO_TEXT.

  methods DEFINE_SCHEDULE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ATTDOC
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_DOC_CONTENT_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_DOC_CONTENT_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'attDoc' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_DOC_CONTENT_MPC=>TS_ATTDOC' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'attDocSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'schedule' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_DOC_CONTENT_MPC=>TS_SCHEDULE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'schedule' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200221110319'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'schedule'.                            "#EC NOTEXT
