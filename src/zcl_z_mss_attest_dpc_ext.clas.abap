class ZCL_Z_MSS_ATTEST_DPC_EXT definition
  public
  inheriting from ZCL_Z_MSS_ATTEST_DPC
  create public .

public section.

  constants C_MEMORY_ID type TEXT20 value 'ZHR_PA_D029' ##NO_TEXT.
...
CLASS ZCL_Z_MSS_ATTEST_DPC_EXT IMPLEMENTATION.
...
*
  ...
  METHOD get_report_xml.
    ...
    lo_assistent->ws_get_attest_xml( EXPORTING  iv_euser       = ls_input-entrance_user
                                          IMPORTING  e_xstring       = e_xstring
                                          EXCEPTIONS no_pernr       = 1
                                                     no_sec_lev_ruk = 2 ).
    e_filename = 'ATTEST.xlsx'.
