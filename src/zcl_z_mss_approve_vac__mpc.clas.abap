class ZCL_Z_MSS_APPROVE_VAC__MPC definition
  public
...
public section.
  ...
  types:
     TS_VACAPPLICATIONAR type ZMSS_VACATION_APPLICATION .
  types:
TT_VACAPPLICATIONAR type standard table of TS_VACAPPLICATIONAR .
  types:
...
TT_VACAPPLICATION type standard table of TS_VACAPPLICATION .
  ...
  constants GC_VACAPPLICATIONAR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VacApplicationAR' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_APPROVE_VAC__MPC====CP' ##NO_TEXT.

  methods DEFINE_VACAPPLICATIONAR
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_Z_MSS_APPROVE_VAC__MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_APPROVE_VAC_APPL_SRV' ).

define_vacapplicationar( ).
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_VACAPPLICATIONAR.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - VacApplicationAR
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VacApplicationAR' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VacApplicationARSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210617055020'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'VacApplicationAR'.                            "#EC NOTEXT
