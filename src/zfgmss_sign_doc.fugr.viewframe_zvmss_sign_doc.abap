*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVMSS_SIGN_DOC
*   generation date: 19.10.2017 at 10:56:08
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVMSS_SIGN_DOC      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVMSS_SIGN_DOC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVMSS_SIGN_DOC_EXTRACT
TOTAL = ZVMSS_SIGN_DOC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVMSS_SIGN_DOC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVMSS_SIGN_DOC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVMSS_SIGN_DOC_EXTRACT
TOTAL = ZVMSS_SIGN_DOC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVMSS_SIGN_DOC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVMSS_SIGN_DOC'
...
TOTAL = ZVMSS_SIGN_DOC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVMSS_SIGN_DOC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVMSS_SIGN_DOC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVMSS_SIGN_DOC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVMSS_SIGN_DOC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVMSS_SIGN_DOC_EXTRACT
TOTAL = ZVMSS_SIGN_DOC_TOTAL
