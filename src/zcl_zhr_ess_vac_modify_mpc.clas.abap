class ZCL_ZHR_ESS_VAC_MODIFY_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_MODIFY_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_MODIFY_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_MODIFY_SRV' ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BegdaNew' iv_abap_fieldname = 'BEGDA_NEW' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EnddaNew' iv_abap_fieldname = 'ENDDA_NEW' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 8 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200321151817'.                  "#EC NOTEXT
