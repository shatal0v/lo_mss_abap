class ZCL_MSS_LIST_IPR_MPC definition
  public
...
public section.
  ...
  types:
TT_LISTIPR type standard table of TS_LISTIPR. .
  types:
  ...
  constants GC_LISTIPR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ListIPR' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_MSS_LIST_IPR_MPC==========CP' ##NO_TEXT.

  methods DEFINE_LISTIPR
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_MSS_LIST_IPR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_LIST_IPR_SRV' ).

define_listipr( ).
  endmethod.


  method DEFINE_LISTIPR.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ListIPR' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Plans' iv_abap_fieldname = 'PLANS' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_MSS_LIST_IPR_MPC=>TS_LISTIPR' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ListIPRSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20171011123103'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ListIPR'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Plans'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ListIPR'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
