class ZCL_ZHR_XSS_LEGEND_COL_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_XSS_LEGEND_COL_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_XSS_LEGEND_COL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_XSS_LEGEND_COL_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'GroupAwart' iv_abap_fieldname = 'GROUPID' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'GroupAwartText' iv_abap_fieldname = 'DESCRIPTION' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHR_XSS_LEGEND_COL_MPC=>TS_ENTITYMAIN' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20191206150849'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'GroupAwart'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'GroupAwartText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
