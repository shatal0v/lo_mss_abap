class ZCL_Z_MSS_VAC_CALENDAR_MPC definition
  public
...
TT_ENTITYABS type standard table of TS_ENTITYABS. .
  types:
  begin of TS_HOLIDAY,
     LOGINACTDIR type C length 30,
     BEGDA type C length 30,
     ENDDA type C length 30,
     TYPE type string,
     TEXT type string,
  end of TS_HOLIDAY. .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_VAC_CALENDAR_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_Z_MSS_VAC_CALENDAR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_VAC_CALENDAR_SRV' ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Main_User' iv_abap_fieldname = 'MAINUSER' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Entrance_User' iv_abap_fieldname = 'LOGIN_ACT_DIR' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Entrance_User' iv_abap_fieldname = 'LOGINACTDIR' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_VAC_CALENDAR_MPC=>TS_HOLIDAY' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200330100047'.                  "#EC NOTEXT
