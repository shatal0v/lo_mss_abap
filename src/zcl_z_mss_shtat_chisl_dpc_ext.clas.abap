class ZCL_Z_MSS_SHTAT_CHISL_DPC_EXT definition
  public
  inheriting from ZCL_Z_MSS_SHTAT_CHISL_DPC
  create public .

public section.

  constants C_MEMORY_ID type TEXT20 value 'ZHR_OM_D005' ##NO_TEXT.
...
CLASS ZCL_Z_MSS_SHTAT_CHISL_DPC_EXT IMPLEMENTATION.
  ...
  method EMP_RESERV_SET_GET_ENTITYSET.
   DATA: BEGIN OF ls_input
    ...
    TRY.
        ...
        lo_assistent->ws_get_shtat_chisl_xml( EXPORTING  iv_euser       = ls_input-entrance_user
