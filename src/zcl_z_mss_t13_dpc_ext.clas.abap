class ZCL_Z_MSS_T13_DPC_EXT definition
  public
  inheriting from ZCL_Z_MSS_T13_DPC
  create public .

public section.

  constants C_MEMORY_ID type TEXT20 value 'ZHR_PA_D013' ##NO_TEXT.
  constants C_MEMORY_XML type TEXT20 value 'ZHR_PA_D0131' ##NO_TEXT.
  constants C_MEMORY_XML1 type TEXT20 value 'ZHR_PA_D0132' ##NO_TEXT.
...
CLASS ZCL_Z_MSS_T13_DPC_EXT IMPLEMENTATION.
...
*
  ...
  METHOD GET_REPORT_XML.
    ...
    lo_assistent->ws_get_T13_xml( EXPORTING  iv_euser       = ls_input-entrance_user
                                  IMPORTING  e_xstring       = e_xstring
                                  EXCEPTIONS no_pernr       = 1
                                             no_sec_lev_ruk = 2 ).
    e_filename = 'ZHR_PA_D013.xlsx'.
