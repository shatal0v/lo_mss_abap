class ZCL_Z_MSS_ATTEST_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_EMP_ATTEST,
     MAIN_USER type TEXT100,
     ENTRANCE_USER type TEXT100,
     CONTENT type string,
     MSGID type C length 255,
     MESSAGE type C length 220,
  end of TS_EMP_ATTEST. .
  types:
TT_EMP_ATTEST type standard table of TS_EMP_ATTEST. .
  types:
  ...
  constants GC_EMP_ATTEST type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Emp_Attest' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_ATTEST_MPC==========CP' ##NO_TEXT.

  methods DEFINE_EMP_ATTEST
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_ATTEST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_ATTEST_SRV' ).

define_emp_attest( ).
  endmethod.


  method DEFINE_EMP_ATTEST.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Emp_Attest' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_ATTEST_MPC=>TS_EMP_ATTEST' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Emp_Attest_Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200424062546'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Emp_Attest'.                            "#EC NOTEXT
