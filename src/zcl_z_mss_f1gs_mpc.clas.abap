class ZCL_Z_MSS_F1GS_MPC definition
  public
...
public section.
  ...
  types:
TT_EMP_F1GS type standard table of TS_EMP_F1GS. .
  types:
  ...
  constants GC_EMP_F1GS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Emp_F1gs' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_F1GS_MPC============CP' ##NO_TEXT.

  methods DEFINE_EMP_F1GS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_F1GS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_F1GS_SRV' ).

define_emp_f1gs( ).
  endmethod.


  method DEFINE_EMP_F1GS.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Emp_F1gs' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_F1GS_MPC=>TS_EMP_F1GS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Emp_F1gs_Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200430062747'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Emp_F1gs'.                            "#EC NOTEXT
