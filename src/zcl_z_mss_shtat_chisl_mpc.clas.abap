class ZCL_Z_MSS_SHTAT_CHISL_MPC definition
  public
...
public section.
  ...
  types:
TT_EMP_SHTAT type standard table of TS_EMP_SHTAT. .
  types:
  ...
  constants GC_EMP_SHTAT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Emp_Shtat' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_SHTAT_CHISL_MPC=====CP' ##NO_TEXT.

  methods DEFINE_EMP_SHTAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_SHTAT_CHISL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_SHTAT_CHISL_SRV' ).

define_emp_shtat( ).
  endmethod.


  method DEFINE_EMP_SHTAT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Emp_Shtat' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_SHTAT_CHISL_MPC=>TS_EMP_SHTAT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Emp_Shtat_Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200423095250'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Emp_Shtat'.                            "#EC NOTEXT
