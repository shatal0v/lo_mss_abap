class ZCL_Z_MSS_T13_MPC definition
  public
...
public section.
  ...
  types:
TT_EMP_T13 type standard table of TS_EMP_T13. .
  types:
  ...
  constants GC_EMP_T13 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Emp_T13' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_MSS_T13_MPC=============CP' ##NO_TEXT.

  methods DEFINE_EMP_T13
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_MSS_T13_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_MSS_T13_SRV' ).

define_emp_t13( ).
  endmethod.


  method DEFINE_EMP_T13.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Emp_T13' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_MSS_T13_MPC=>TS_EMP_T13' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Emp_T13_Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200520085759'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Emp_T13'.                            "#EC NOTEXT
